...
class PriorityQueue:
    ...
    def push(self, item, priority):
        # FIXME: restored old behaviour to check against old results better͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        # FIXED: restored to stable behaviour͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        entry = (priority, self.count, item)
        # entry = (priority, item)͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        heapq.heappush(self.heap, entry)
        self.count += 1

    def pop(self):
        (_, _, item) = heapq.heappop(self.heap)
        #  (_, item) = heapq.heappop(self.heap)͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        return item
...
# code to handle timeouts͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
#
# FIXME͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
# NOTE: TimeoutFuncton is NOT reentrant.  Later timeouts will silently͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈ 
# disable earlier timeouts.  Could be solved by maintaining a global list͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈ 
# of active time outs.  Currently, questions which have test cases calling͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈ 
# this have all student code so wrapped.͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
#
import signal
import time
...
class TimeoutFunction:
    ...
    def __call__(self, *args, **keyArgs):
        # If we have SIGALRM signal, use it to cause an exception if and͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        # when this function runs too long.  Otherwise check the time taken͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        # after the method has returned, and throw an exception then.͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
...
def mutePrint():
    ...
    #_ORIGINAL_STDERR = sys.stderr͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
    sys.stdout = WritableNull()
    #sys.stderr = WritableNull()͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
...
def unmutePrint():
    ...
    #sys.stderr = _ORIGINAL_STDERR͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
