...
# attribution to UC Berkeley, including a link to http://inst.eecs.berkeley.edu/~cs188/pacman/pacman.html͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
# 
...
class EightPuzzleState:
    ...
    def result(self, move):
        ...
        # Create a copy of the current eightPuzzle͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        newPuzzle = EightPuzzleState([0, 0, 0, 0, 0, 0, 0, 0, 0])
        newPuzzle.cells = [values[:] for values in self.cells]
        # And update it to reflect the move͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
    ...
    # Utilities for comparison and display͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
...
# TODO: Implement The methods in this class͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
...
def createRandomEightPuzzle(moves=100):
    ...
    for i in range(moves):
        # Execute a random legal move͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
