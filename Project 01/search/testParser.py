...
class TestParser(object):
    ...
    def __init__(self, path):
        # save the path to the test file͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        self.path = path

    def removeComments(self, rawlines):
        # remove any portion of a line following a '#' symbol͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        fixed_lines = []
        for l in rawlines:
            idx = l.find('#')
            if idx == -1:
    ...
    def parse(self):
        # read in the test case and remove comments͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        test = {}
        ...
        i = 0
        # read a property in each loop cycle͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
        while(i < len(lines)):
            # skip blank lines͏󠄂͏️͏󠄌͏󠄎͏︁͏󠄑͏︈
