...
# imports from python standard library͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
import grading
import imp
import optparse
import os
...
# register arguments and set default values͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
def readCommand(argv):
    ...
    # BEGIN SOLUTION NO PROMPT͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    parser.set_defaults(generatePublicTests=False)
    # END SOLUTION NO PROMPT͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
# confirm we should author solution files͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
def confirmGenerate():
...
# TODO: Fix this so that it tracebacks work correctly͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# Looking at source of the traceback module, presuming it works͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# the same as the intepreters, it uses co_filename.  This is,͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# however, a readonly attribute.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
def setModuleName(module, filename):
    ...
    for i in dir(module):
        ...
        if type(o) == functionType:
            ...
            setattr(o, '__file__', filename)
            # TODO: assign member __file__'s?͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        #print i, type(o)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅


#from cStringIO import StringIO

def loadModuleString(moduleSource):
    # Below broken, imp doesn't believe its being passed a file:͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    #    ValueError: load_module arg#2 should be a file or None͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    #
    #f = StringIO(moduleCodeDict[k])͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    #tmp = imp.load_module(k, f, k, (".py", "r", imp.PY_SOURCE))͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
#######################################################################
# Error Hint Map͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#######################################################################

# TODO: use these͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
ERROR_HINT_MAP = {
  'q1': {
...
def runTest(testName, moduleDict, printTestCase=False, display=None):
    ...
    # This is a fragile hack to create a stub grades object͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    grades = grading.Grades(projectParams.PROJECT_NAME, [(None,0)])
    testCase.execute(grades, moduleDict, solutionDict)


# returns all the tests you need to run in order to run question͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
def getDepends(testParser, testRoot, question):
    ...
    if 'depends' in questionDict:
        ...
        for d in depends:
            # run dependencies first͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            allDeps = getDepends(testParser, testRoot, d) + allDeps
    return allDeps

# get list of questions to grade͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
# evaluate student code͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
def evaluate(generateSolutions, testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP,
    ...
    # imports of testbench code.  note that the testClasses import must follow͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    # the import of student code due to dependencies͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    import testParser
    import testClasses
    for module in moduleDict:
        setattr(sys.modules[__name__], module, moduleDict[module])
    ...
    for q in test_subdirs:
        ...
        # create a question object͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        ...
        # load test cases into question͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        ...
        for t in sorted(tests):
            ...
            def makefun(testCase, solution_file):
                if generateSolutions:
                    # write solution file to disk͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
                    return lambda grades: testCase.writeSolution(moduleDict, solution_file)
                else:
                    # read in solution dictionary and pass as an argument͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
                    testDict = testParser.TestParser(test_file).parse()
        ...
        # Note extra function is necessary for scoping reasons͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
def copy(srcDir, destDir, filename):
    ...
    # with open(os.path.join(srcDir, filename), 'r') as f1:͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    #     with open(os.path.join(destDir, filename), 'w') as f2:͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    #         f2.write(f1.read())͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
if __name__ == '__main__':
    ...
    # moduleCodeDict = {}͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    # for cp in codePaths:͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    #     moduleName = re.match('.*?([^/]*)\.py', cp).group(1)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    #     moduleCodeDict[moduleName] = readFile(cp, root=options.codeRoot)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    # moduleCodeDict['projectTestClasses'] = readFile(options.testCaseCode, root=options.codeRoot)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    # moduleDict = loadModuleDict(moduleCodeDict)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    try:
        ...
        if options.gsOutput:
            ...
            # total of entire submission͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            out_dct['score'] = 0
