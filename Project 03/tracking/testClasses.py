...
# import modules from python standard library͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
import inspect
import re
import sys
...
def invertLayout(layout_text):
    # Keep lower left fix as this is hardcoded in PositionSearchProblem (gah)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    # as the goal.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    for y, line in enumerate(lines):
        for x, tile in enumerate(line):
            # (x,y)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            # (0,0) -> (h,w)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            # (0,h) -> (0,w)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    #return layout_text͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    return "\n".join(new_lines)
# END SOLUTION NO PROMPT͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅

# Class which models a question in a project.  Note that questions have a͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# maximum number of points they are worth, and are composed of a series of͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# test cases͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
class Question(object):
    ...
    # Note that 'thunk' must be a function which accepts a single argument,͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    # namely a 'grading' object͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
# Question in which all test cases must be passed in order to receive credit͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
class PassAllTestsQuestion(Question):

    def execute(self, grades):
        # TODO: is this the right way to use grades?  The autograder doesn't seem to use it.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        testsFailed = False
...
# Question in which predict credit is given for test cases with a ``points'' property.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# All other tests are mandatory and must be passed.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
class HackedPartialCreditQuestion(Question):
    ...
    def execute(self, grades):
        ...
        ## FIXME: Below terrible hack to match q3's logic͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
# Template modeling a generic test case͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
class TestCase(object):
    ...
    # Tests should call the following messages for grading͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    # to ensure a uniform format for test output.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    #
    # TODO: this is hairy, but we need to fix grading.py's interface͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    # to get a nice hierarchical project - question - test structure,͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    # then these should be moved into Question proper.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    # This should really be question level?͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    #
