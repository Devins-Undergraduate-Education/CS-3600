# distanceCalculator.py͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# ---------------------͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
class Distancer:
  def __init__(self, layout, background=True, default=10000):
    ...
    # Start computing distances in the background; when the dc finishes,͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    # it will fill in self._distances for us.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
##########################################
# MACHINERY FOR COMPUTING MAZE DISTANCES #͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
##########################################
