...
########################################
# Parameters for noisy sensor readings #͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
########################################
...
class GameState:
    ...
    ##############################
    # Additions for Busters Pacman #͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ##############################
...
def runGames( layout, pacman, ghosts, display, numGames, maxMoves=-1):
    # Hack for agents writing to the display͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    import __main__
