# graphicsUtils.py͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# ----------------͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
def begin_graphics(width=640, height=480, color=formatColor(0, 0, 0), title=None):
    ...
    # Check for duplicate call͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    if _root_window is not None:
        # Lose the window.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        _root_window.destroy()

    # Save the canvas size parameters͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    _canvas_xs, _canvas_ys = width - 1, height - 1
    _canvas_x, _canvas_y = 0, _canvas_ys
    _bg_color = color

    # Create the root window͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    _root_window = tkinter.Tk()
    _root_window.protocol('WM_DELETE_WINDOW', _destroy_window)
    _root_window.title(title or 'Graphics Window')
    _root_window.resizable(0, 0)

    # Create the canvas object͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    try:
    ...
    # Bind to key-down and key-up events͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
def _destroy_window(event=None):
    sys.exit(0)
#    global _root_window͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#    _root_window.destroy()͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#    _root_window = None͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    #print "DESTROY"͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
def image(pos, file="../../blueghost.gif"):
    x, y = pos
    # img = PhotoImage(file=file)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
def moveCircle(id, pos, r, endpoints=None):
    ...
    x, y = pos
#    x0, x1 = x - r, x + r + 1͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#    y0, y1 = y - r, y + r + 1͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    x0, x1 = x - r - 1, x + r
    y0, y1 = y - r - 1, y + r
    if endpoints == None:
        e = [0, 359]
...
##############################################################################
### Keypress handling ########################################################͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
##############################################################################

# We bind to key-down and key-up events.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅

_keysdown = {}
_keyswaiting = {}
# This holds an unprocessed key release.  We delay key releases by up to͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# one call to keys_pressed() to get round a problem with auto repeat.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
_got_release = None

def _keypress(event):
    global _got_release
    #remap_arrows(event)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    _keysdown[event.keysym] = 1
    _keyswaiting[event.keysym] = 1
#    print event.char, event.keycode͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    _got_release = None
...
def remap_arrows(event):
    # TURN ARROW PRESSES INTO LETTERS (SHOULD BE IN KEYBOARD AGENT)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
# Block for a list of keys...͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
