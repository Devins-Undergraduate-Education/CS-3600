# trackingTestClasses.py͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# ---------------------------͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
class GameScoreTest(testClasses.TestCase):
    ...
    def execute(self, grades, moduleDict, solutionDict):
        ...
        #if self.inference == "ExactInference":͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        #    pac.inferenceModules = [moduleDict['inference'].ExactInference(a) for a in ghosts]͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        #else:͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        #    print "Error inference type %s -- not implemented" % self.inference
        #    return͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
class DoubleInferenceAgentTest(testClasses.TestCase):
    ...
    def execute(self, grades, moduleDict, solutionDict):
        ...
        moves = []
        # Collect solutions͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        for l in lines:
            m = re.match('(\d+) (\w+) (.*)', l)
    ...
    def writeSolution(self, moduleDict, filePath):
        ...
        # run our gold code here and then write it to a solution file͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
class InferenceAgent(bustersAgents.BustersAgent):
    ...
    def __init__( self, inference, ghostAgents, seed, elapse=True, observe=True, burnIn=0):
        ...
        self.burnIn = burnIn
        self.numMoves = 0
        #self.rand = rand͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        # list of tuples (move_num, move, [dist_1, dist_2, ...])͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.answerList = []
        self.seed = seed
...
class DoubleInferenceAgent(bustersAgents.BustersAgent):
    ...
    def distCompare(self, dist, refDist):
        ...
        # copy and prepare distributions͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        dist = dist.copy()
        ...
        for key in set(list(refDist.keys()) + list(dist.keys())):
            ...
            if not key in refDist.keys():
                refDist[key] = 0.0
        # calculate l2 difference͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        ...
        if l2 > self.L2Tolerance:
            ...
            self.errors += 1
        # check for uniform distribution if necessary͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
class DispersingSeededGhost( Agent):
    ...
    def getDistribution( self, state ):
        ...
        # get other ghost positions͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        ...
        # for each action, get the sum of inverse squared distances to the other ghosts͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        sumOfDistances = []
