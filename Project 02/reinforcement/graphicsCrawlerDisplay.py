# graphicsCrawlerDisplay.py͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# -------------------------͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
# Student side autograding was added by Brad Miller, Nick Hay, and Pieter͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# Abbeel in Spring 2013.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# For more info, see http://inst.eecs.berkeley.edu/~cs188/pacman/pacman.html͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
class Application:
    ...
    def incrementSpeed(self, inc):
        self.tickTime *= inc
#        self.epsilon = min(1.0, self.epsilon)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#        self.epsilon = max(0.0,self.epsilon)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#        self.learner.setSpeed(self.epsilon)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    def __initGUI(self, win):
        ## Window ##͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.win = win

        ## Initialize Frame ##͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        win.grid()
        self.dec = -.5
        self.inc = .5
        self.tickTime = 0.1

        ## Epsilon Button + Label ##͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.setupSpeedButtonAndLabel(win)

        self.setupEpsilonButtonAndLabel(win)

        ## Gamma Button + Label ##͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.setUpGammaButtonAndLabel(win)

        ## Alpha Button + Label ##͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.setupAlphaButtonAndLabel(win)

        ## Exit Button ##͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        #self.exit_button = tkinter.Button(win,text='Quit', command=self.exit)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        #self.exit_button.grid(row=0, column=9)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅

        ## Simulation Buttons ##͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#        self.setupSimulationButtons(win)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    def __init__(self, win):
        ...
        self.al = 2
        self.stepCount = 0
        ## Init Gui͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅

        self.__initGUI(win)

        # Init environment͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    def run(self):
        ...
        while True:
            ...
            self.stepsToSkip = 0
            self.step()
#          self.robot.draw()͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
