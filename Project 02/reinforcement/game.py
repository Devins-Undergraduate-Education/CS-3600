...
# game.py͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# -------͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# Licensing Information: Please do not distribute or publish solutions to this͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# project. You are free to use and extend these projects for educational͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# purposes. The Pacman AI projects were developed at UC Berkeley, primarily by͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# John DeNero (denero@cs.berkeley.edu) and Dan Klein (klein@cs.berkeley.edu).͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# For more info, see http://inst.eecs.berkeley.edu/~cs188/sp09/pacman.html͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
#######################
# Parts worth reading #͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#######################
...
class AgentState:
    ...
    def __init__(self, startConfiguration, isPacman):
        ...
        self.scaredTimer = 0
        # state below potentially used for contest only͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.numCarrying = 0
        self.numReturned = 0
...
class Grid:
    ...
    def __hash__(self):
        # return hash(str(self))͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        base = 1
        h = 0
        for l in self.data:
            for i in l:
...
####################################
# Parts you shouldn't have to read #͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
####################################
...
class Actions:
    ...
    def getPossibleActions(config, walls):
        ...
        # In between grid points, all agents must continue straight͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
class GameStateData:
    ...
    def __eq__(self, other):
        ...
        if other == None:
            return False
        # TODO Check for type of other͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
class Game:
    ...
    def unmute(self):
        if not self.muteAgents:
            return
        global OLD_STDOUT, OLD_STDERR
        # Revert stdout/stderr to originals͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    def run(self):
        ...
        # self.display.initialize(self.state.makeObservation(1).data)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        # inform learning agents of the game start͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        for i in range(len(self.agents)):
            agent = self.agents[i]
            if not agent:
                self.mute(i)
                # this is a null agent, meaning it failed to load͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
                # the other team wins͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            ...
            if ("registerInitialState" in dir(agent)):
                ...
                # TODO: could this exceed the total time͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
                self.unmute()
        ...
        while not self.gameOver:
            # Fetch the next agent͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            agent = self.agents[agentIndex]
            move_time = 0
            skip_action = False
            # Generate an observation of the state͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            ...
            # Solicit an action͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            action = None
            self.mute(agentIndex)
            if self.catchExceptions:
                try:
            ...
            ###self.display.update( self.state.makeObservation(idx).data )͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅

            # Allow for game specific conditions (winning, losing, etc.)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            self.rules.process(self.state, self)
            # Track progress͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            if agentIndex == numAgents + 1:
                self.numMoves += 1
            # Next agent͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
            agentIndex = (agentIndex + 1) % numAgents

            if _BOINC_ENABLED:
                boinc.set_fraction_done(self.getProgress())

        # inform a learning agent of the game result͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
