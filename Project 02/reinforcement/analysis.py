...
######################
# ANALYSIS QUESTIONS #͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
######################

# Set the given parameters to obtain the specified policies through͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# value iteration.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
def question3a():
    answerDiscount = 0.3
    answerNoise = 0.0
    answerLivingReward = -0.015
    return answerDiscount, answerNoise, answerLivingReward
    # If not possible, return 'NOT POSSIBLE'͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
