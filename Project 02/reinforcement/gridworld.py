...
class Gridworld(mdp.MarkovDecisionProcess):
    ...
    def __init__(self, grid):
        # layout͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        if type(grid) == type([]): grid = makeGrid(grid)
        self.grid = grid

        # parameters͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    def getStates(self):
        ...
        """
        # The true terminal state.͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
def runEpisode(agent, environment, discount, decision, display, message, pause, episode):
    ...
    while True:
        ...
        # DISPLAY CURRENT STATE͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        state = environment.getCurrentState()
        display(state)
        pause()

        # END IF IN A TERMINAL STATE͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        actions = environment.getPossibleActions(state)
        if len(actions) == 0:
            message("EPISODE "+str(episode)+" COMPLETE: RETURN WAS "+str(returns)+"\n")
            return returns

        # GET ACTION (USUALLY FROM AGENT)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        action = decision(state)
        if action == None:
            raise Exception('Error: Agent returned None action')

        # EXECUTE ACTION͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        nextState, reward = environment.doAction(action)
        message("Started in state: "+str(state)+
                "\nTook action: "+str(action)+
                "\nEnded in state: "+str(nextState)+
                "\nGot reward: "+str(reward)+"\n")
        # UPDATE LEARNER͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
def parseOptions():
    ...
    # MANAGE CONFLICTS͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    if opts.textDisplay or opts.quiet:
    # if opts.quiet:͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        opts.pause = False
        # opts.manual = False͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
if __name__ == '__main__':
    ...
    ###########################
    # GET THE GRIDWORLD͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ###########################
    ...
    ###########################
    # GET THE DISPLAY ADAPTER͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ###########################
    ...
    if opts.agent == 'value':
        ...
        #env.getPossibleActions, opts.discount, opts.learningRate, opts.epsilon͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        #simulationFn = lambda agent, state: simulation.GridworldSimulation(agent,state,mdp)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        ...
        # # No reason to use the random agent without episodes͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        if opts.episodes == 0:
            opts.episodes = 10
        class RandomAgent:
    ...
    ###########################
    # RUN EPISODES͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ###########################
    # DISPLAY Q/V VALUES BEFORE SIMULATION OF EPISODES͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    try:
    ...
    # FIGURE OUT WHAT TO DISPLAY EACH TIME STEP (IF ANYTHING)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    # FIGURE OUT WHETHER TO WAIT FOR A KEY PRESS AFTER EACH TIME STEP͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    pauseCallback = lambda : None
    if opts.pause:
        pauseCallback = lambda : display.pause()

    # FIGURE OUT WHETHER THE USER WANTS MANUAL CONTROL (FOR DEBUGGING AND DEMOS)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    if opts.manual:
    ...
    # DISPLAY POST-LEARNING VALUES / Q-VALUES͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
