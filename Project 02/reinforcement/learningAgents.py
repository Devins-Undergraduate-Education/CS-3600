# learningAgents.py͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
# -----------------͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
class ValueEstimationAgent(Agent):
    ...
    ####################################
    #    Override These Functions      #͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ####################################
...
class ReinforcementAgent(ValueEstimationAgent):
    ...
    ####################################
    #    Read These Functions          #͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ####################################
    ...
    def stopEpisode(self):
        ...
        if self.episodesSoFar >= self.numTraining:
            # Take off the training wheels͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    ################################
    # Controls needed for Crawler  #͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ################################
    ...
    ###################
    # Pacman Specific #͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ###################
    ...
    def final(self, state):
        ...
        # Make sure we have this var͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
