...
class CrawlingRobotEnvironment(environment.Environment):
    ...
    def __init__(self, crawlingRobot):
        ...
        # The state is of the form (armAngle, handAngle)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        # where the angles are bucket numbers, not actual͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        # degree measurements͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.state = None

        self.nArmStates = 9
        self.nHandStates = 13

        # create a list of arm buckets and hand buckets to͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        # discretize the state space͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    def doAction(self, action):
        ...
        # a simple reward function͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        reward = newX - oldX
    ...
    def reset(self):
        ...
        """
        ## Initialize the state to be the middle͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        ## value for each parameter e.g. if there are 13 and 19͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        ## buckets for the arm and hand parameters, then the intial͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        ## state should be (6,9)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        ##
        ## Also call self.crawlingRobot.setAngles()͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        ## to the initial arm and hand angle͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
class CrawlingRobot:
    ...
    def moveArm(self, newArmAngle):
        ...
        # Position and Velocity Sign Post͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.positions.append(self.getRobotPosition()[0])
#        self.angleSums.append(abs(math.degrees(oldArmAngle)-math.degrees(newArmAngle)))͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        if len(self.positions) > 100:
            self.positions.pop(0)
 #           self.angleSums.pop(0)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    def moveHand(self, newHandAngle):
        ...
        # Position and Velocity Sign Post͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.positions.append(self.getRobotPosition()[0])
 #       self.angleSums.append(abs(math.degrees(oldHandAngle)-math.degrees(newHandAngle)))͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        if len(self.positions) > 100:
            self.positions.pop(0)
 #           self.angleSums.pop(0)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    ## You shouldn't need methods below here͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
    ...
    def draw(self, stepCount, stepDelay):
        ...
        ## Check Lower Still on the ground͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        if y1 != self.groundY:
        ...
        # Position and Velocity Sign Post͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#        time = len(self.positions) + 0.5 * sum(self.angleSums)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#        velocity = (self.positions[-1]-self.positions[0]) / time͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#        if len(self.positions) == 1: return͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        steps = (stepCount - self.lastStep)
        if steps==0:return
 #       pos = self.positions[-1]͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#        velocity = (pos - self.lastPos) / steps͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
  #      g = .9 ** (10 * stepDelay)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#        g = .99 ** steps͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#        self.velAvg = g * self.velAvg + (1 - g) * velocity͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
 #       g = .999 ** steps͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
 #       self.velAvg2 = g * self.velAvg2 + (1 - g) * velocity͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
#        velMsg2 = '1000-step Avg Velocity: %.2f' % self.velAvg2
 ...
 #           self.canvas.delete(self.velavg2_msg)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
 #       self.velavg2_msg = self.canvas.create_text(850,190,text=velMsg2)͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
...
#        self.lastPos = pos͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.lastStep = stepCount
#        self.lastVel = velocity͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅

    def __init__(self, canvas):

        ## Canvas ##͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.canvas = canvas
        self.velAvg = 0
#        self.velAvg2 = 0͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
#        self.lastPos = 0͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
        self.lastStep = 0
#        self.lastVel = 0͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅

        ## Arm and Hand Degrees ##͏󠄂͏️͏󠄌͏󠄎͏︄͏︊͏󠄅
