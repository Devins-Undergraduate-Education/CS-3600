...
while perceptrons <= 40:
	...
	for n in range(5):
		nnet, testAccuracy = testXorData(hiddenLayers = [perceptrons])
		q7xordata.append(testAccuracy)


	penStats = {}
	penStats['max'] = max(q7xordata)
	penStats['average'] = average(q7xordata)
	penStats['stDev'] = stDeviation(q7xordata)
	penoutput[perceptrons] = (q7xordata, penStats)
